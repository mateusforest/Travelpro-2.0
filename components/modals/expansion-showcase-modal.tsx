      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 z-[90] flex items-end lg:items-center lg:justify-center lg:p-4"
            onClick={(event) => event.stopPropagation()}
          >
            <div className="w-full max-h-[calc(100vh-1rem)] overflow-hidden rounded-t-[2rem] bg-[#fcfcfb] shadow-2xl lg:w-[min(42rem,calc(100vw-2rem))] lg:max-h-[85vh] lg:rounded-[2rem]">
