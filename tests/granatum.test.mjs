...
test('Granatum SQL keeps secrets private, leases exclusive and import atomic/idempotent',async t=>{
 ...
 for(const file of ['20260917_finance.sql','20260918_finance_conflicts.sql','20260919_granatum.sql'])await db.exec(readFileSync('supabase/migrations/'+file,'utf8'));
 ...
 const data=normalizeGranatum(raw(),'2026-01-01T00:00:00Z');
